 ...
 *      access.
 */
public class ApachePOIExcelRead078 {
	...
	public static void main(String[] args) {
		...
		for(String [] temp : new ApachePOIExcelRead078().getExcelContent(fileName,"TestData",START_ROW, START_COL, TOTAL_ROWS, TOTAL_COLUMNS)){
			for(String  tt : temp){
				if (tt !=null) {
