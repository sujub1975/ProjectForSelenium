...
public class ELTC_047_POM {
	private WebDriver driver;		
	
    public ELTC_047_POM(WebDriver driver) {
        this.driver = driver; 
	...
	private WebElement addCourCatCode;	
	...
	public void addCourCatCode1(String addCourCatCode) 
	{
		this.addCourCatCode.clear();
		this.addCourCatCode.sendKeys(addCourCatCode);
	}
